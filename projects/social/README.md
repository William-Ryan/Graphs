...
A: You would call it a total of 500 times. 100 users with an average of 10 friends each would total to 1000 friends, but since each friendship is a pair and not a new set and add_friendship accounts for 2 adds (you adding the friend and the friend adding you), you half that number and get 500.
